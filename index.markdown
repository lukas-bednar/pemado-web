...
Na začátku roku 2018 získala firma PEMADO s.r.o. certifikát [FSC 100%]({{ site.data.cert.fsc.url }}){: target="_blank" } pro své podpalovače z dřevité vlny a certifikát kvality [RAL]({{ site.data.cert.ral.pdf | relative_url }}){: target="_blank" } pro svíčky, což potvrzuje kvalitu a udržitelnost jejich produktů. V březnu téhož roku firma otevřela firemní prodejnu ve městě Žamberk.
{: .text-justify }
