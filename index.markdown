...
#  nav: products
---
## Zapalte své smysly pomocí výrobků PEMADO
...
Pro svou výrobu zakoupili výrobní prostor v Rokytnici v Orlických horách, kde dodnes provozují svou výrobu.
{: .text-justify }


Na začátku roku 2018 získala firma PEMADO s.r.o. certifikát FSC ([{{ site.data.cert.fsc.id }}]({{ site.data.cert.fsc.url }}){: target="_blank" }) pro své podpalovače z dřevité vlny a certifikát [RAL]({{ site.data.cert.ral.pdf | relative_url }}){: target="_blank" } pro svíčky, což potvrzuje kvalitu a udržitelnost jejich produktů. V březnu téhož roku firma otevřela svou firemní prodejnu ve městě Žamberk.
{: .text-justify }
