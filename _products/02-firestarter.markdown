 ...
 * ®️  **Certfikované:** [FSC 100%]({{ site.data.cert.fsc.pdf | relative_url }}){: target="_blank" }, [{{ site.data.cert.fsc.id }}]({{ site.data.cert.fsc.url }}){: target="_blank" }
...
![fsc-logo]({{ site.data.cert.fsc.img | relative_url }}){: .certificate-img-right }
